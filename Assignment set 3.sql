...
update customers set creditLimit= creditLimit*0.10;
...
-- Q5.Find the minimum and maximum amounts in the dataset.movies select 
select * from movies;

#Use movies table
-- Q6.What are the titles of all movies in the "Animations" category?
select title from movies where category="Animations";

-- Q7.How many movies belong to the "Action" category?
select count(category)from movies where category="Action";
-- Q8.Write an SQL query to update the category of "Marley and Me" from "Romance" to "Drama".
update movies set category="Drama" where title="Marley and Me" and  category="Romance";
